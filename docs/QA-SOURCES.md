...
Owner: QA. Status: v0.2 (2026-09-13), executed against `7e13053` (results in
`docs/QA-RESULTS.md`, section "M2-01 Sources pass on 7e13053"). v0.1 was
