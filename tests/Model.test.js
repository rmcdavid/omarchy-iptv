...
check("buildMpvArgv fixed options in order", argv.slice(2, 9), ["--wayland-app-id=omarchy-iptv", "--force-window=immediate", "--idle=no", "--keep-open=no", "--title=BBC One", "--force-media-title=BBC One", "--msg-level=all=error"])
